/* BLAKE3 1.8.7 API with Digestif-specific symbol prefixes.
 * See blake3.c for the pinned upstream source and section conventions.
 * The upstream API is CC0 1.0 licensed.
 */
#ifndef CRYPTOHASH_BLAKE3_H
#define CRYPTOHASH_BLAKE3_H

/* BEGIN Digestif: API symbol mapping */
/* Avoid collisions with other libraries that also link BLAKE3. */
...
#endif /* BLAKE3_H */
/* END upstream: c/blake3.h */

#endif /* CRYPTOHASH_BLAKE3_H */
