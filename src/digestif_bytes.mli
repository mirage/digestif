...
val blit_from_bigstring: Digestif_bigstring.t -> int -> t -> int -> int -> unit
...
val be32_from_bigstring_to_cpu: Digestif_bigstring.t -> int -> int32
val be32_from_bytes_to_cpu: Bytes.t -> int -> int32
val le32_to_cpu: t -> int -> int32
val le32_from_bigstring_to_cpu: Digestif_bigstring.t -> int -> int32
val le32_from_bytes_to_cpu: Bytes.t -> int -> int32
val be64_to_cpu: t -> int -> int64
val be64_from_bigstring_to_cpu: Digestif_bigstring.t -> int -> int64
val be64_from_bytes_to_cpu: Bytes.t -> int -> int64
val le64_to_cpu: t -> int -> int64
val le64_from_bigstring_to_cpu: Digestif_bigstring.t -> int -> int64
