...
(* OASIS_START *)
(* DO NOT EDIT (digest: f842a4508cf3ffd805089d1c2a4e1b81) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Provides simples encryption algorithms in pure OCaml.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\178\229S\227>\189\023T4\133?&\006\029\238\243";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
