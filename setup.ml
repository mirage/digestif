...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5315de1f5fded3e8aa843ef46d51b3ca) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./oshaone_test", []))];
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Provides a simple SHA-1 encryption algorithm in pure OCaml.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\233LF\201*\001\173\015\006\157AUs9]\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
