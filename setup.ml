...
(* OASIS_START *)
(* DO NOT EDIT (digest: c2270863f3352ac0b1925420c729da20) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./digestif_test", []))];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Eyy\195\188b (Eyyub) Sari"];
          homepage = None;
          synopsis = "Provides simple encryption algorithms in pure OCaml.";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Sha1"; "Sha256"];
                      lib_pack = false;
                      lib_internal_modules = ["Common"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\216\191gQ/\215\2316:\133\190\208\214\175\221\229";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
